...
export default function Ph() {
  ...
  useEffect(() => {
    // reference to notifications/ph
    const dbRef = ref(database, "notifications/ph");
      ...
      <FlatList showsVerticalScrollIndicator={false}  
        ...
        renderItem={({ item }) => (
          <View style={styles.card}>
           ...
           <Text style={styles.message}>pH out of range: <Text style={styles.value}>{item.value}</Text></Text>
          </View>
        )}
      />
    </View>
