...
export default function Turbidity() {
  ...
  const [selectedItem, setSelectedItem] = useState<"today" | "month" | "year">("today");

  useEffect(() => {
    // reference to notifications/turbidity
    const dbRef = ref(database, "notifications/turbidity");
      ...
      <FlatList showsVerticalScrollIndicator={false}  
        ...
        renderItem={({ item }) => (
          <View style={styles.card}>
            ...
            <Text style={styles.message}>Turbidity out of range: <Text style={styles.value}>{item.value}</Text></Text>
          </View>
        )}
      />
    </View>
